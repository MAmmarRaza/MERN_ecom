...
function ProductsDetail() {
    ...
    const addToCart = (productToAdd) => {
        ...
        const existingProduct = cartItems.find((item) => item._id === productToAdd._id && item.selectedSize === selectedSize);

        // If the product is not in the cart, add it to the cart with an initial quantity of 1
        if (!existingProduct) {
            cartItems.push({ ...productToAdd, quantity: quantity, price: quantity * productToAdd.price, selectedSize: selectedSize });
            Swal.fire({
                icon: 'success',
                title: 'Success',
                text: 'Added to Cart!'
    ...
    // handle checout click 
    const handleCheckoutClick = () => {
        Swal.fire({
          icon: 'info',
          title: 'Please Login!',
          html: 'You need to login before checkout! <a href="/signin">SignIn</a>',
                                ...
                                <div className="ps-lg-3">
                                    ...
                                    <div className="row mb-4">
                                        <div className="col-md-4 col-6">
                                            ...
                                            <select className="form-select border border-secondary" style={{ height: "35px" }} value={selectedSize} onChange={handleSizeChange} >
                                        ...
                                        <div className="col-md-4 col-6 mb-3">
                                            ...
                                            <div className="input-group mb-3" style={{ width: "170px" }}>
                                                ...
                                                <input id="quantityValue" type="number" disabled className="form-control text-center border border-secondary" value={quantity} onChange={e => setQuantity(Number(e.target.value))} aria-label="Example text with button addon" aria-describedby="button-addon1" />
                                    ...
                                    {authToken ? (
                                        ...
                                        <div onClick={handleCheckoutClick} className="btn btn-warning shadow-0"> check out </div>
                                    )}
